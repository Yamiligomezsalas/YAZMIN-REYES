...
public class Vizualizacion extends javax.swing.JFrame {

    
    public Vizualizacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        botondeAgregar = new javax.swing.JButton();
        ...
        botondeAgregar.setBackground(new java.awt.Color(255, 255, 255));
        botondeAgregar.setText("Agregar");
        botondeAgregar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botondeAgregarActionPerformed(evt);
            }
        });
        ...
        txtSal.setForeground(new java.awt.Color(255, 51, 51));
        txtSal.setRows(5);
    ...
    private void botondeAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botondeAgregarActionPerformed
    if (nombre.getText().isEmpty()==false)
        txtSal.setText(nombre.getText());
    else
    {
        JOptionPane.showMessageDialog(null,"ingrese dato xfis");
    }
        
    }//GEN-LAST:event_botondeAgregarActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vizualizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vizualizacion().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton botondeAgregar;
